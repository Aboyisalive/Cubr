    ...
    <div className="relative h-full overflow-hidden bg-[#020305]">
      ...
      {waitlistOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-5 backdrop-blur-sm"
          ...
          <section className="landing-copy w-full max-w-md rounded-[var(--radius-card)] border border-white/20 bg-[#0b0d12]/95 p-6 shadow-2xl sm:p-8"
            ...
            <div className="mb-6 flex items-start justify-between gap-4">
              ...
              <button type="button"
                ...
                aria-label="Close waitlist dialog" onClick={() => setWaitlistOpen(false)}>
